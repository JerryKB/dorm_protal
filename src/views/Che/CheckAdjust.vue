<template>
    <div>
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="调换宿舍号" prop="t_id">
        ...
        <el-dialog title="申请单" :visible.sync="dialogTableVisible"  class="titleClass el-dialogClass" style="width: auto;padding: 0">
            <el-table :data="stateData" style="padding: 0">
                ...
                <el-table-column property="t_id" label="调换宿舍号" width="200"></el-table-column>
                <el-table-column property="reason" label="申请原因"></el-table-column>
                <el-table-column property="edit_time" label="提交时间"></el-table-column>
                <el-table-column property="permit_state" label="申请状态">
                    <template slot-scope="scope">
                        <p v-if="stateData[scope.$index].permit_state==0"><el-tag type="info">未解决</el-tag></p>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    t_id: [
                        { required: true, message: '请输入调换的宿舍号', trigger: 'blur' }
                    ],
                    reason: [
        ...
        methods: {
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        postRequest('/adjust-room/',this.ruleForm).then((res)=>{
            ...
            checkForm(){
                ...
                getRequest('/adjust-room/').then((res)=>{
                    this.stateData = res;
                })
            }
        }
